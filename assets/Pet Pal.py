...
bark_sound = pygame.mixer.Sound(os.path.join(current_dir, "assets", "bark.wav"))
...
def generate_ai_message(mood, hunger, energy, happiness, recent_action=None):
    try:
        ...
        response = openai_client.chat.completions.create(
            ...
            messages=[
                {"role": "system",
                 "content": "You are a cute virtual pet who speaks in short, adorable messages with text based emojis (e.g. :D)."},
